...
# Copy migrate_versions
migrate_directory=$nova_directory/db/sqlalchemy/migrate_repo/versions
rm $migrate_directory/242_placeholder.py*
cp source/migrate_versions/242_traffic_tables.py $migrate_directory/242_traffic_tables.py
rm $migrate_directory/243_placeholder.py*
cp source/migrate_versions/243_topology_tables.py $migrate_directory/243_topology_tables.py

# Sync the db with new tables

nova-manage db sync --version 241
nova-manage db sync
